...
def load_ebm_model(len_dataset):
    ...
    checkpoint_path = "/zhome/75/a/187019/dev/energy-based-representation-learning/models_4700.pth"
    """
    ...
    # Load checkpoint
    checkpoint = torch.load(checkpoint_path, map_location=device)["ebm_state"]
...
def main():
    ...
    print("Step 3: Load the EBM model")
